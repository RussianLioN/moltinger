...
const INTERNAL_CAPABILITY_DISCLOSURE_RE =
  /(?:у меня есть доступ к|i have access to|мне доступны).{0,200}(?:create_skill\b|update_skill\b|patch_skill\b|delete_skill\b|write_skill_files\b|skills?\b|tavily\b|mcp__[\p{L}\p{N}_:.-]+)/iu;
