...
agent_factory_suite_entries() {
    ...
    case "$lane" in
        component)
            ...
            optional_suite_entry bash component_agent_factory_web_discovery_runtime "Agent factory web discovery runtime" "$SCRIPT_DIR/component/test_agent_factory_web_discovery_runtime.sh"
            ...
            optional_suite_entry bash component_agent_factory_web_brief_runtime "Agent factory web brief runtime" "$SCRIPT_DIR/component/test_agent_factory_web_brief_runtime.sh"
