...
bash|component_moltis_codex_advisory_send|Moltis Codex advisory sender adapter|$SCRIPT_DIR/component/test_moltis_codex_advisory_send.sh
bash|component_moltis_codex_advisory_rollout_config|Moltis Codex advisory rollout config|$SCRIPT_DIR/component/test_moltis_codex_advisory_rollout_config.sh
