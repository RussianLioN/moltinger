...
bash|component_moltis_canonical_smoke|Moltis canonical smoke component|$SCRIPT_DIR/component/test_moltis_canonical_smoke.sh
bash|component_moltis_runtime_attestation|Moltis runtime attestation component|$SCRIPT_DIR/component/test_moltis_runtime_attestation.sh
bash|component_moltis_exercised_surface_matrix|Moltis exercised surface matrix component|$SCRIPT_DIR/component/test_moltis_exercised_surface_matrix.sh
bash|component_moltis_session_reconcile|Moltis session reconcile component|$SCRIPT_DIR/component/test_moltis_session_reconcile.sh
