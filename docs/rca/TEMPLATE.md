...
- [дополнительные historical notes/SESSION_SUMMARY.md при необходимости]

**Релевантные прошлые RCA/уроки:**
1. [RCA/lesson #1] — [что уже покрывает]
2. [RCA/lesson #2] — [какой guard/check нужно было переиспользовать]

**Что могло быть упущено без этой сверки:**
- [факт/проверка/контекст #1]
- [факт/проверка/контекст #2]

**Что в текущем инциденте действительно новое:**
- [новый фактор, которого нет в текущей базе уроков]
