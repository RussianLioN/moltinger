...
- [x] Hook bootstrap-source preservation fixed in [post-checkout](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/.githooks/post-checkout)
- [x] Hook bootstrap-source preservation fixed in [post-merge](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/.githooks/post-merge)
- [x] Exact Phase A executor guidance added to [worktree-ready.sh](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/scripts/worktree-ready.sh)
- [x] Worktree command contract clarified in [worktree.md](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/.claude/commands/worktree.md)
- [x] Hook regression added in [test_beads_git_hooks.sh](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/tests/unit/test_beads_git_hooks.sh)
- [x] Create-path regression added in [test_worktree_ready.sh](/Users/rl/coding/moltinger/029-beads-dolt-native-migration/tests/unit/test_worktree_ready.sh)
