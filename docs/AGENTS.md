...
If the work is about creating, migrating, or reviewing Moltis skills/agents, read [docs/moltis-skill-agent-authoring.md](./moltis-skill-agent-authoring.md) before writing or restructuring prompts, skills, presets, scheduler paths, or migration docs.
