...
|-------|-----------|--------|-------|
| Moltis skill/agent authoring | [Authoring guide](../moltis-skill-agent-authoring.md), [Self-learning handbook](../knowledge/MOLTIS-SELF-LEARNING-INSTRUCTION.md), [Official runtime contract](./moltis-official-skill-runtime-contract-2026-03-27.md) | Guide updated | Canonical project guidance now separates repo skill source from official live discovery/runtime proof. |
| Moltis official version-update channel | [Research](./moltis-official-version-update-channel-2026-03-20.md), [RCA](../rca/2026-03-13-moltis-official-docker-channel-and-gitops-repair.md) | Research complete, contract applied | Confirms official Docker channel, release-to-GHCR tag normalization (`vX.Y.Z` -> `X.Y.Z`), and deterministic GitOps pinning contract. |
| Moltis/OpenClaw Telegram long-running delivery patterns | [Research](./moltis-telegram-long-running-reliability-and-cloneable-agent-patterns-2026-03-29.md), [Activity-log upstream artifact](../reports/2026-03-28-moltis-upstream-telegram-codex-update-and-activity-log-issue-artifact.md) | Research complete | Synthesizes official docs, upstream issues, and community signals into a practical architecture for long-running Telegram tasks, background execution, completion delivery, and `Activity log` leak containment. |
