...
|-------|-----------|--------|-------|
| Moltis skill/agent authoring | [Authoring guide](../moltis-skill-agent-authoring.md), [Self-learning handbook](../knowledge/MOLTIS-SELF-LEARNING-INSTRUCTION.md) | Guide ready | Canonical project guidance for adding Moltis-native skills/agents and migrating capabilities from Claude Code, Codex, and OpenCode. |
