...
|-------|-----------|--------|-------|
| Cline Kanban + durable worktree integration | [Index](./cline-kanban-worktree-index-2026-04-01.md), [Analysis](./cline-kanban-worktree-moltinger-analysis-2026-04-01.md), [Consilium review](../reports/consilium/2026-04-01-cline-kanban-worktree-plan-review.md), [Runbook](../runbooks/cline-kanban-worktree-workflow.md) | Research complete, operator guidance ready | Recommends a hybrid model: repo-native durable lanes, Cline workflows/hooks as UX, and Kanban only for subtask execution via `--base-ref`. |
