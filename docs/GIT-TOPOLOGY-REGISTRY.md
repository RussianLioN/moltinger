...
| `moltinger-v0-10-18-prod` | `DETACHED` | `sibling-worktree` | Needs decision |
...
| `primary-feature-023` | `023-telegram-factory-adapter` | `dedicated-feature-worktree` | Needs decision |
