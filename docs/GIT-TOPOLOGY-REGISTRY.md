...
| `moltinger-moltis-pin-v0-10-18-prod` | `fix/moltis-prod-0-10-18-gitops-guard` | `sibling-worktree` | Needs decision |
...
| `fix/moltis-prod-0-10-18-gitops-guard` | `origin/main` | Needs decision |
