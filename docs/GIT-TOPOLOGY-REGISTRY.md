...
| `moltinger-main-gpt54-integration` | `DETACHED` | `sibling-worktree` | Needs decision |
...
| `moltis-regular-update-proposal` | `feat/moltis-regular-update-proposal` | `sibling-worktree` | Needs decision |
...
| `origin/integration/gpt54-main` | Needs decision |
