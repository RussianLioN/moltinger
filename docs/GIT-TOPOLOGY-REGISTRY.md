...
| `primary-feature-017` | `017-clawdiy-remote-oauth-lifecycle` | `dedicated-feature-worktree` | Needs decision |
...
| `017-clawdiy-remote-oauth-lifecycle` | `none` | Needs decision |
